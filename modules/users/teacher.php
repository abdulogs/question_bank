        ...
        echo '
          <div class="dropdown">
              ...
              <ul class="dropdown-menu shadow border-0">
                  <li>
                      <a class="dropdown-item" href="u-teacher-details.php?id='.$id.'">
                          <span class="bx bx-show text-success align-middle"></span> Details 
                      </a>
                  </li>
                  <li>
                      <a class="dropdown-item" href="u-teacher-update.php?id='.$id.'">
                          <span class="bx bx-edit text-success align-middle"></span> Update 
                      </a>
                  </li>
                  <li>
                      <a class="dropdown-item" href="'."u-teachers".'.php?id='.$id.'&action=delete">
