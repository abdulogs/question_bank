...
<body class="layout d-flex h-100">
    ...
    <main class="content h-100 d-flex flex-column bg-white">
        ...
        <header class="bg-white">
            ...
            <nav class="d-flex align-items-center border-bottom py-2 px-3">
                ...
                <div class="ms-auto d-flex align-items-center">
                    <a href="topic-create.php" class="d-flex align-items-center btn btn-primary">
        ...
        <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item">
                    <a href="topics.php" class="text-decoration-none text-dark">Topics</a>
                </li>
        ...
        <table class="table table-card  mb-0 font-12">
                <thead class="bg-light">
                    <tr>
                        ...
                        <th class="border-bottom text-uppercase text-muted" scope="col">Chapter</th>
                ...
                <tbody class="font-12">
                    ...
                    <?php foreach($listing as $item): ?>
                        <tr>
                            ...
                            <td class="align-middle" data-label="Chapter">
                                <?php echo $item["chapter"]; ?>
                            </td>
                            <td class="align-middle" data-label="Subject">
                                <?php echo $item["subject"]; ?>
                            </td>
                            <td class="align-middle" data-label="Class">
                                <?php echo $item["class"]; ?>
                            </td>
