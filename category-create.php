...
<head>
    ...
    <title>Category create - Dashboard</title>
    <!-- Seo tags -->
            ...
            <form class="card col-sm-5 shadow" method="post">
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control form-control-lg shadow-none border font-14" name="statement" required/>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="row">
                        <div class="form-group mb-3 col-sm-6">
                            ...
                            <input class="form-control form-control-lg shadow-none border font-14" name="ordering" required/>
                        </div>
                        <div class="form-group mb-3 col-sm-6">
