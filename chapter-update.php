...
<!-- Module -->
<?php f::module("syllabus/chapters"); ?>
<?php module::delete(); ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Chapter update - Dashboard</title>
    <!-- Seo tags -->
...
<body class="layout d-flex h-100">
    ...
    <main class="content h-100 d-flex flex-column bg-white">
        ...
        <!-- Navbar -->
        <!-- Breadcrumb -->
        <nav class="border-bottom px-3 py-2 bg-white">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item">
                    <a href="chapters.php" class="text-decoration-none text-dark">Chapters</a>
                </li>
            ...
            <div class="col-sm-5">
                ...
                <form class="card  shadow " autocomplete="off" method="post">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group mb-3 col-sm-6">
                                ...
                                <input class="form-control form-control-lg shadow-none border font-14" name="name" value="<?php echo $data["name"]; ?>" required/>
                            </div>
                            <div class="form-group mb-3 col-sm-6">
                                <label class=" mb-0 font-14" for="assign_id"><b>Subject</b></label>
                                <select name="assign_id" class="form-select shadow-none border form-control-lg font-14"
                                    required>
                    ...
                    <div class="card-footer border-top bg-light text-center">
                        <a href="chapters.php" class="btn btn-light font-14 ps-5 pe-5 border"><b>Go back</b></a>
