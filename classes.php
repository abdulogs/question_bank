...
<!-- Module -->
<?php f::module("management/classes"); ?>
<?php module::delete(); ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="layout d-flex h-100">
    ...
    <main class="content h-100 d-flex flex-column bg-white">
        ...
        <header class="bg-white">
            ...
            <nav class="d-flex align-items-center border-bottom py-2 px-3">
                ...
                <div class="ms-auto d-flex align-items-center">
                    <a href="class-create.php" class="d-flex align-items-center btn btn-primary">
        ...
        <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item">
                    <a href="classes.php" class="text-decoration-none text-dark">Classes</a>
                </li>
        ...
        <section class="overflow-auto h-100">
            <table class="table table-card  mb-0 font-12">
                ...
                <tbody class="font-12">
                    ...
                    <?php else:?>
                        <tr>
                            <td class="text-center text-danger" colspan="7"><b>No records found!</b></td>
                        </tr>
                    <?php endif;?>
                </tbody>
            </table>
