    ...
    <main class="content h-100 d-flex flex-column bg-white">
        ...
        <header class="bg-white">
            ...
            <nav class="d-flex align-items-center border-bottom py-2 px-3">
                ...
                <div class="ms-auto d-flex align-items-center">
                    <a href="paper-generate-1.php" class="d-flex align-items-center btn btn-primary">
        ...
        <nav class="border-bottom px-3 py-2 bg-light">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item">
                    <a href="papers.php" class="text-decoration-none text-dark">
                        Generated
                    </a>
                </li>
        ...
        <table class="table table-card  mb-0 font-12">
                <thead class="bg-light">
                    <tr>
                        ...
                        <th class="border-bottom text-uppercase text-muted" scope="col">Chapters</th>
                        <th class="border-bottom text-uppercase text-muted" scope="col">Marks</th>
                        <th class="border-bottom text-uppercase text-muted" scope="col">Time</th>
                ...
                <?php $listing = module::listing(); ?>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-break" data-label="Chapters">
                            <?php echo $item["chapters"]; ?>
                        </td>
                        <td class="align-middle text-break" data-label="Marks">
                            <?php echo $item["total_marks"]." ".f::is_plural($item["total_marks"],"mark"); ?>
                        </td>
                        <td class="align-middle text-break" data-label="Time">
                            <?php echo $item["total_time"]." ".f::is_plural($item["total_time"],"min")?>
                        </td>
                    ...
                    <?php else:?>
                        <tr>
                            <td class="text-center text-danger" colspan="10"><b>No records found!</b></td>
                        </tr>
                    <?php endif;?>
                </tbody>
            </table>
