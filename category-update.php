...
<!-- Module -->
<?php f::module("question_bank/categories"); ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Category update - Dashboard</title>
    <!-- Seo tags -->
    ...
    <main class="content h-100 d-flex flex-column bg-white">
        ...
        <nav class="border-bottom px-3 py-2 bg-light">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item">
                    <a href="categories.php" class="text-decoration-none text-dark">Category</a>
                </li>
                ...
                <form class="card  shadow " autocomplete="off" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control form-control-lg shadow-none border font-14" value="<?php echo $data["statement"]; ?>" name="statement" required/>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="row">
                            <div class="form-group mb-3 col-sm-6">
                                <label class=" mb-0 font-14" for="ordering"><b>Ordering</b></label>
                                <input class="form-control form-control-lg shadow-none border font-14" value="<?php echo $data["ordering"]; ?>" name="ordering" type="text" />
                            </div>
                            <div class="form-group mb-3 col-sm-6">
                    ...
                    <div class="card-footer border-top bg-light text-center">
                        <a href="categories.php" class="btn btn-light font-14 ps-5 pe-5 border"><b>Go back</b></a>
