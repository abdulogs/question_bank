    ...
    <main class="content h-100 d-flex flex-column bg-white">
        ...
        <nav class="border-bottom px-3 py-2 bg-light">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item">
                    <a href="classes.php" class="text-decoration-none text-dark">Class</a>
                </li>
        ...
        <?php module::create(); ?>
            <form class="card col-sm-5 shadow" method="post">
                ...
                <div class="card-footer border-top bg-white text-center">
                    <a href="classes.php" class="btn btn-light font-14 ps-5 pe-5 border"><b>Go back</b></a>
