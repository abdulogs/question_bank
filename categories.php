...
<body class="layout d-flex h-100">
    ...
    <main class="content h-100 d-flex flex-column bg-white">
        ...
        <header class="bg-white">
            ...
            <nav class="d-flex align-items-center border-bottom py-2 px-3">
                ...
                <div class="ms-auto d-flex align-items-center">
                    <a href="category-create.php" class="d-flex align-items-center btn btn-primary">
        ...
        <table class="table table-card  mb-0 font-12">
                <thead class="bg-light">
                    <tr>
                        ...
                        <th class="border-bottom text-uppercase text-muted" scope="col">Ordering</th>
                ...
                <tbody class="font-12">
                    ...
                    <tr>
                        ...
                        <td class="align-middle" data-label="Statement">
                            <?php echo $item["statement"]; ?>
                        </td>
                        <td class="align-middle" data-label="Name">
                            <?php echo $item["name"]; ?>
                        </td>
                        <td class="align-middle" data-label="Ordering">
        ...
        <footer class=" border-top px-3 py-2 text-center bg-light">
            <?php DB::btns("categories", $listing);  ?>
        </footer>
        <!-- Content -->
    </main>
