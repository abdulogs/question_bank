...
<head>
    ...
    <title>Assigned classes & subjects - Dashboard</title>
    <!-- Seo tags -->
        ...
        <header class="bg-white">
            ...
            <nav class="d-flex align-items-center border-bottom py-2 px-3">
                ...
                <div class="ms-auto d-flex align-items-center">
                    <a href="assign-cs-create.php" class="d-flex align-items-center btn btn-primary">
            ...
            <table class="table table-card  mb-0 font-12">
                ...
                <tbody class="font-12">
                    ...
                    <tr>
                        ...
                        <td class="align-middle" data-label="Teacher">
                    ...
                    <?php else:?>
                        <tr>
                            <td class="text-center text-danger" colspan="8"><b>No records found!</b></td>
                        </tr>
                    <?php endif;?>
                </tbody>
            </table>
