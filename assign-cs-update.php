...
<head>
    ...
    <title>Update assigned class & subject - Dashboard</title>
    <!-- Seo tags -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group mb-3 col-sm-6">
                                ...
                                <option value="<?php echo $option["id"]; ?>"<?php echo ($option["id"] == $data["class_id"]) ? "selected" : "" ?>>
                            ...
                            <div class="form-group mb-3 col-sm-6">
                                ...
                                <?php $subjects = module::subjects(); ?>                                    
                                    ...
                                    <option value="<?php echo $option["id"]; ?>"<?php echo ($option["id"] == $data["subject_id"]) ? "selected" : "" ?>>
                                        <?php echo $option["name"]; ?>
                                    </option>
                                    <?php endforeach;?>
                                </select>
                            ...
                            <div class="form-group mb-3 col-sm-6">
                                ...
                                <option value="<?php echo $option["id"]; ?>" <?php echo ($data["teacher_id"] == $option["id"]) ? "selected" : "" ?>>
